...
const Category = (props) => {
    ...
    return <div className={s.card}>
        ...
        {redactorMode ? <UpdateCategory SetImg={props.SetImg} onSubmit={onSubmit} Cancel={setRedactorMode}
            initialValues={{ name: props.name, catalog_id: props.catalog_id, img: props.img, category_id: props.category_id }} /> : <>
                <img src={props.img} alt="" />
                <h2 onClick={() => { props.onCategoryClick(props.category_id, props.name) }}>{props.name}</h2>
